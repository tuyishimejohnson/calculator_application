...
const Calculator = () => {
    ...
    return (
        ...
        <div className='w-1/3 m-auto items-center'>
            <h1 className='text-center  bg-gray-500 py-3 text-3xl text-white font-bold'>Calculator Application</h1>
            ...
            <div>
                <div className='grid grid-cols-4 gap-2'>
                    ...
                    {numbers.map((num, index) => (
                        <span key={index} className={`border flex justify-center py-4 border-black ${num == 0 ? "col-span-2" : num}`} onClick={() => handleClick(num)}>{num}</span>
